...
export default function P2POnboarding() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "#161b22", borderRadius: 16, padding: 32, maxWidth: 440,
        width: "90%", boxShadow: "0 20px 60px rgba(0,0,0,0.5)",
        border: "1px solid #30363d",
      }}>
        <h3 style={{ margin: "0 0 4px", fontSize: 22, color: "#e6edf3" }}>
        ...
        <div style={{
          ...
          background: "#0d1117", borderRadius: 12, padding: 20, minHeight: 110,
          border: "1px solid #21262d",
        }}>
          <div style={{ fontSize: 36, lineHeight: 1 }}>{steps[step].icon}</div>
          <div>
            <h4 style={{ margin: "0 0 6px", fontSize: 16, color: "#e6edf3" }}>
              {steps[step].title}
            </h4>
        ...
        <div style={{ display: "flex", gap: 6, justifyContent: "center", margin: "20px 0" }}>
          {steps.map((_, i) => (
            <span key={i} style={{
              ...
              background: i === step ? "#2563eb" : "#30363d", transition: "all 0.2s",
            }} />
          ))}
        </div>
