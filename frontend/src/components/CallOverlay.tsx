...
import type { CallInfo } from "../services/callService"
import { acceptCall, endCall, rejectCall, toggleMute, toggleVideo } from "../services/callService"
...
interface Props {
  ...
  setCallVideoOff: (v: boolean) => void
}

export default function CallOverlay({ activeCall, callMuted, setCallMuted, callVideoOff, setCallVideoOff }: Props) {
  ...
  return (
    <div className="call-overlay">
      ...
      {activeCall.isVideo && !isIncoming && (
        <video
          className="call-local-video"
          ref={(el) => { if (el && activeCall.localStream) el.srcObject = activeCall.localStream }}
      ...
      <div className="call-overlay-controls">
        {isIncoming ? (
          <>
            <button className="call-control-btn accept" onClick={() => void acceptCall()} title={t("call.accept")}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
            </button>
            <button className="call-control-btn hangup" onClick={() => void rejectCall()} title={t("call.decline")}>
          ...
          <>
            <button className={`call-control-btn ${callMuted ? "active" : ""}`}
            ...
            <button className="call-control-btn hangup" onClick={endCall} title={t("call.hangup")}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91" /></svg>
            </button>
            <button className={`call-control-btn ${callVideoOff ? "active" : ""}`}
